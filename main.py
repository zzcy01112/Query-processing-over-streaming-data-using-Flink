...
from modules.parseCsvData import parse_fields, parse_line
...
if __name__ == '__main__':
    ...
    # 设置并行度
    flink_env.set_parallelism(4)

    # 将lines转换为Flink数据流
    data_stream = flink_env.read_text_file("./data/test.csv")
    ...
    aggregation_process = lineitem_process.key_by(
    ...
    # 打印最终聚合结果
    aggregation_process.map(lambda agg: f"OrderKey: {agg.l_orderkey}, OrderDate: {agg.o_orderdate}, "
